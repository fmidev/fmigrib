...
__device__ void UnpackFullBytes(const unsigned char* __restrict__ d_p, double* __restrict__ d_u,
...
__device__ void UnpackUnevenBytes(const unsigned char* __restrict__ d_p, double* __restrict__ d_u,
                                  const int* __restrict__ d_b, NFmiGribPacking::packing_coefficients coeff, int idx)
{
	int j = 0;
	unsigned long lvalue;
...
__global__ void UnpackSimpleKernel(double* d_u, const unsigned char* d_p, const int* d_b, size_t N,
...
bool NFmiGribPacking::simple_packing::Unpack(double* arr, const unsigned char* packed, const int* d_bitmap,
